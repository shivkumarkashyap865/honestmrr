...
<script src="{'../' if path.count('/') else ''}assets/chat.js" defer></script>
</body>
</html>"""
...
<div class="cta" style="margin-top:18px"><a class="btn btn-primary" href="mailto:honestmrr.official@gmail.com?subject=Project%20inquiry%20%E2%80%94%20HonestMRR%20Studio">📩 Request a free quote</a><a class="btn" href="mailto:honestmrr.official@gmail.com">honestmrr.official@gmail.com</a></div>
<p style="color:var(--muted);font-size:13px;margin-top:10px">We reply within 24 hours with a fixed quote — no hidden charges.</p>
</div>
<div class="cards">
...
"""
with open(os.path.join(OUT, "assets", "chat.js"), "w") as f:
    f.write(CHAT_JS)
